...
public partial interface IProductReviewModelFactory
{
    ...
    /// <summary> MY CUSTOM FOR TASK#1
    /// Prepares the product review statistics model
    /// </summary>
    /// <param name="productId">Product identifier</param>
    /// <returns>
    /// A task that represents the asynchronous operation
    /// The task result contains the product review stats model
    /// </returns>
    Task<ProductReviewStatsModel> PrepareProductReviewStatsModelAsync(int productId);
    #endregion
